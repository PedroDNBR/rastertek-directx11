...
{
	// Shutdown the vertex and pixel shaders as well the related objects
	ShutdownShader();
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// Initialize the pointers this function you use to null
	errorMessage = 0;
...
void LightShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	// Pop a message up on the screen to notify yhe user to check the text file for compile errors
...
)
{
	...
	// Lock the constant buffer so it can be written up
	...
	// Copy the matricies into the constant buffer
	...
	// Lock the light cosntant buffer so it can be written to
